      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 xl:px-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-6">
            About <span className="text-accent">Empty AI Agency</span>
          </h1>
          <p className="text-xl text-foreground/70 max-w-3xl mx-auto">
            We&apos;re building the future of software development in Angola with AI-powered automation and modern technology.
          </p>
        </div>
        ...
        <section className="mb-20">
          <div className="bg-muted rounded-2xl p-12 border border-border">
            ...
            <p className="text-lg text-foreground/70 text-center max-w-4xl mx-auto leading-relaxed">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* EmptyBot */}
            <div className="bg-muted rounded-2xl p-8 border border-border hover:border-accent transition-colors">
              <div className="w-20 h-20 bg-accent/10 rounded-full flex items-center justify-center mb-6">
                <svg className="w-10 h-10 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold mb-2">EmptyBot</h3>
              <p className="text-accent font-medium mb-4">Lead AI Agent</p>
            ...
            <div className="bg-muted rounded-2xl p-8 border border-border hover:border-accent transition-colors">
              ...
              <h3 className="text-2xl font-bold mb-2">Autonomous Sub-Agents</h3>
              <p className="text-accent font-medium mb-4">Specialized AI Workforce</p>
              <p className="text-foreground/70">
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-lg text-foreground/70 mb-8 max-w-2xl mx-auto">
            We&apos;re always looking for exciting projects and partnerships in Angola and beyond.
          </p>
          <a 
            href="/contact" 
