        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background p-8 rounded-lg border border-border hover:border-accent transition-colors">
              ...
              <h3 className="text-2xl font-bold mb-3">{t('services.aiAutomation.title')}</h3>
            ...
            <div className="bg-background p-8 rounded-lg border border-border hover:border-accent transition-colors">
              ...
              <h3 className="text-2xl font-bold mb-3">{t('services.fullStack.title')}</h3>
              <p className="text-foreground/70">
            ...
            <div className="bg-background p-8 rounded-lg border border-border hover:border-accent transition-colors">
              ...
              <h3 className="text-2xl font-bold mb-3">{t('services.scalable.title')}</h3>
              <p className="text-foreground/70">
          ...
          <div className="bg-muted rounded-2xl overflow-hidden border border-border hover:border-accent transition-colors">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 lg:p-12">
              <div className="flex flex-col justify-center">
                <h3 className="text-3xl font-bold mb-4">{t('featured.projectTitle')}</h3>
