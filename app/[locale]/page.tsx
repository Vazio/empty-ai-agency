...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-800">
        {/* Gradient overlay */}
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-24 text-center">
          ...
          <h1 className="font-bold mb-6 text-white animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <span className="gradient-text">{t('hero.title')}</span>
            <br />
            <span className="text-gray-100">{t('hero.subtitle')}</span>
          </h1>
          
          <p className="text-lg sm:text-xl lg:text-2xl text-white/70 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
            {t('hero.description')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <a 
              href="./contact" 
              className="px-8 py-4 border-2 border-angola-red/20 bg-gray-900 text-angola-red hover:border-angola-red hover:bg-angola-red/5 rounded-xl font-semibold text-base shadow-soft hover:shadow-soft-lg transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5"
            >
              {t('hero.getInTouch')}
            </a>
          </div>
          ...
          <div className="max-w-5xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="relative group">
              ...
              <div className="relative backdrop-blur-sm bg-gray-900/80 rounded-2xl border border-white/10 shadow-soft-lg overflow-hidden transform group-hover:-translate-y-1 group-hover:shadow-xl transition-all duration-500">
      ...
      <section className="py-20 sm:py-24 lg:py-32 bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="group relative">
              ...
              <div className="relative h-full bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-white">{t('services.aiAutomation.title')}</h3>
            ...
            <div className="group relative">
              ...
              <div className="relative h-full bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-white">{t('services.fullStack.title')}</h3>
                <p className="text-gray-400 leading-relaxed">
            ...
            <div className="group relative">
              ...
              <div className="relative h-full bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-soft hover:shadow-soft-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-white">{t('services.scalable.title')}</h3>
                <p className="text-gray-400 leading-relaxed">
      ...
      <section className="py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-gray-900 to-gray-950">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          {/* Badge */}
          ...
          <h2 className="font-bold text-center mb-16 text-white">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gray-900 border border-gray-800 rounded-3xl overflow-hidden shadow-soft-lg">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-16">
                  <h3 className="text-3xl sm:text-4xl font-bold mb-4 text-white">{t('featured.projectTitle')}</h3>
                  <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                    {t('featured.projectDescription')}
                  </p>
                  <div className="flex flex-wrap gap-2.5 mb-10">
                    <span className="px-3.5 py-1.5 bg-gray-800 text-gray-300 rounded-lg text-sm font-medium">Next.js 14</span>
                    <span className="px-3.5 py-1.5 bg-gray-800 text-gray-300 rounded-lg text-sm font-medium">TypeScript</span>
                    <span className="px-3.5 py-1.5 bg-gray-800 text-gray-300 rounded-lg text-sm font-medium">Prisma</span>
                    <span className="px-3.5 py-1.5 bg-gray-800 text-gray-300 rounded-lg text-sm font-medium">PostgreSQL</span>
                    <span className="px-3.5 py-1.5 bg-gray-800 text-gray-300 rounded-lg text-sm font-medium">Redis</span>
                  </div>
                  <a 
                ...
                <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 lg:min-h-[500px] overflow-hidden">
                  <img 
                    src="/images/dashboard-preview-placeholder.svg" 
                    alt="Dashboard Financeiro Angola Preview" 
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {['Next.js', 'TypeScript', 'React', 'Prisma', 'PostgreSQL', 'Redis', 'TailwindCSS', 'Node.js', 'Vercel', 'Git', 'REST APIs', 'AI Agents'].map((tech) => (
              <div 
                key={tech} 
                className="group bg-gray-900 border border-gray-800 rounded-xl p-6 text-center hover:-translate-y-1 hover:shadow-soft-lg hover:border-angola-red/20 transition-all duration-300 cursor-default"
              >
                <p className="font-semibold text-white group-hover:text-angola-red transition-colors">{tech}</p>
              </div>
            ))}
          </div>
        </div>
